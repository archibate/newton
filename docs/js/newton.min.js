...
s=t.extend({ctor:function(e){this.bodies=[],this.timeStep=1/60,this.splitSteps=2,this.onTicks=[],this.ticker=new
o,this.getGravity=function(e){return
new
n(0,300)},e|={};for(var
t
in
e)e.hasOwnProperty(t)&&this.hasOwnProperty(t)&&(this[t]=e[t])},start:function(){this.timer=-1,this.timer=this.ticker.timeout(function(e){this.tick(e),this.timer&&this.start()}.bind(this),this.timeStep)},pause:function(){this.ticker.cancel(this.timer),this.timer=undefined},tick:function(e){for(var
t=0;t<this.splitSteps;t++)for(var
n
in
this.bodies){var
r=this.bodies[n];r.tick(e/this.splitSteps)}for(var
t
in
this.onTicks)this.onTicks[t](e)},add:function(e){e.getGravity=this.getGravity.bind(this),this.bodies.push(e)},onTick:function(e){this.onTicks.push(e)}});e.World=s;var
...
n(0,0),this.rotation=0,this.angularVelocity=0,this.invRotationalInertia=0,this.acceleration=new
n(0,0);for(var
t
in
e)e.hasOwnProperty(t)&&this.hasOwnProperty(t)&&(this[t]=e[t]);this.mass!=0?this.invMass=1/this.mass:this.invMass=0},applyImpulse:function(e,t){var
